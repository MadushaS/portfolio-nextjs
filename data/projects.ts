...
const ProjectsList: ProjectType[] = [
  {
    ...
    description:
      "The t5_xsum_samsum_billsum_cnn_dailymail model is a text summarization model fine-tuned on the t5-base architecture, a versatile text-to-text transfer transformer. This powerful model excels at generating abstractive summaries from input text.",
  ...
  },
  {
    ...
    description:
      "This is a web application that allows users to download videos from YouTube. It also allows users to convert the downloaded videos to different formats and resolutions.",
    image: FuzzyYtIcon,
    year: "2023",
  ...
  },
  {
    ...
    description:
      "This is a static website for a pet shop. It is a branding website for a pet shop.",
    image: LilPawsImage,
    year: "2021",
